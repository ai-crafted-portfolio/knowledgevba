...
description: clsUserFormRenderer.cls ÇÃÉ\Å[ÉXÉRÅ[ÉhÅiÉRÉsÉyópÅj
---

# clsUserFormRenderer.cls

**îzíuêÊ**: ã§í ÉÇÉWÉÖÅ[ÉãÅi3 ÉuÉbÉNã§í Åj  
**éÌóﬁ**: ÉNÉâÉXÉÇÉWÉÖÅ[Éã
...
- èÍèä: `C:\KnowledgeMgr\installer\vba_modules\common\\`
- ÉtÉ@ÉCÉãñº: `clsUserFormRenderer.cls`
...
'   formWidth = 540 (àƒAí˘ê≥ mock 720px=540pt), label width = 120, control width = formWidth - 140
...
' --- Layout DEFAULTS (ÅòA4 àƒAí˘ê≥å„ÅEmock èÄãí 540pt/720px; overridable via [USERFORM] stanza) ---
' ÅòA4 é¿ëï SSOT: formWidth=540(pt; mock 720px èÄãí àƒA 2026-05-28), labelWidth=120, headerHeight=48, rowHeight(íPàÍçs/ì˙éû/ëIë)=24,
' rowHeight(ï°êîçs)=60, margin=10, buttonBarHeight=40, button çÇÇ≥=24/ä‘äu=8, bottomMargin=16.
...
' Phase R-3-É‘-3 (2026-05-28): ècï¿Ç— layout (label çsè„ + data çsëSïùâ∫)ÅB
' row pitch(total) = labelZone(18) + dataHeight + rowSpacing(6)ÅB
...
' ècï¿Ç— layout íËêî (label control çÇ / label-data ä‘ gap / data â∫ spacing)ÅB
' label zone = VLABEL_H + VLABEL_GAP = 18ÅBdataHeight = rowPitch - 18 - VROW_SPACINGÅB
...
Private Const DEFAULT_FONT_NAME As String = "ÉÅÉCÉäÉI"
...
Private m_formatRowEnabled As Boolean      ' Phase R-3-É‘-5: format çsï\é¶(default mode=register ÇÃÇ›ÅAui_seed formatRowEnabled Ç≈è„èëÇ´â¬)
...
' Phase R-3-É‘-4 (2026-05-28): àƒC/àƒA scroll âª ? å≈íË header + frScroll FrameÅB
Private Const PROGID_FRAME As String = "Forms.Frame.1"
' V5 fix (2026-05-30) BUG-1: 1080px âÊñ Ç≈ button bar Ç™âÊñ äOÇ…èoÇÈ regression ÇñhÇÆÇΩÇﬂ
' SCROLL_FORM_CAP Ç 900Å®720 Ç…â∫Ç∞ (72pt/inch Å~ 10in = 720pt = ~960pxÅAExcel chrome + taskbar çTèúå„ÇÃ
' à¿ëSåó)ÅBí¥âﬂï™ÇÕ frScroll ì‡ÉXÉNÉçÅ[ÉãÇ≈ãzé˚Ç∑ÇÈÅB
' V4 fix (2026-05-29) #3 óöó: M-09Åuå¥àˆÅvâBÇÍâÒîÇ≈ 900pt Ç…ägí£ÇµÇΩÇ™ÅA1080px screen Ç≈
' button bar âÊñ äOéñåÃÇ™èoÇΩÇΩÇﬂçƒèkè¨ÅBí∑ field ÇÕ frame scroll Ç≈å©ÇπÇÈÅB
Private Const SCROLL_FORM_CAP As Long = 720   ' form inside çÇÇÃè„å¿(pt)ÅBí¥âﬂï™ÇÕ frame ì‡ÉXÉNÉçÅ[ÉãÅB
...
' Phase R-3-É‘-4: scroll âª ? å≈íË header ÇÃâ∫Ç…íuÇ≠ frScroll Frame Ç∆ê°ñ@ÅB
Private m_scrollFrame As Object       ' frScroll Frame (field åQÇÃ container)
Private m_headerHeightPx As Long      ' å≈íË header çÇ(format selector + button bar)
Private m_scrollHeightPx As Long      ' frame ì‡ content total çÇ (= Frame.ScrollHeight)
...
Public Function ShowForm( _
    ...
    ' Phase R-3-É‘-2: preview mode (M-04) ? fixed format from caller, no data load.
    ' M-09 Ç∆ìØ interface (ï\é¶êÍóp popup) Ç≈ÅAç∑ÇÕÅué¿ÉfÅ[É^Ç load ÇµÇ»Ç¢Åvì_ÇÃÇ›ÅB
...
Private Sub InitFormConfig()
    ...
    ' Phase R-3-É‘-5: format çsÇÕä˘íËÇ≈ register ÇÃÇ›ï\é¶(M-04/M-06/M-09 ÇÕñ{ëÃÇ©ÇÁèúäO)ÅB
...
Private Sub ApplyConfigFromStanza(ByVal sec As ClsStanzaSection)
    ...
    ' Phase R-3-É‘-5: format çsÇÃï\é¶â¬î€Ç ui_seed Ç≈ñæé¶è„èëÇ´(M-04/06/09=false)ÅB
...
Private Sub BuildAndShow(ByVal knowledgeData As Object)
    ...
    ' chrome é¿ë™ÇÃÇΩÇﬂ Width/Height ÇébíËê›íË
    ...
    ' V4 fix (2026-05-29) #1/#5 (revised): Frame ÇÃ sunken/etched òg + äDêFîwåiÇè¡Ç∑ÅB
    ' V4-iter1 Ç≈ BorderStyle=fmBorderStyleNone Çí«â¡ÇµÇΩÇÁ M-05 register Ç™
    ' 1 field ÇµÇ©ï`âÊÇ≥ÇÍÇ»Ç¢ regression Ç™èoÇΩÇΩÇﬂ (frame ÇÃ inset+clipping édólïœâª)ÅA
    ' BorderStyle ÇÕ default (0=fmBorderStyleNone ÇÕïœÇ¶Ç∏) + SpecialEffect=0(flat)
    ' + BackColor=îí Ç≈Åuògå©ÇΩñ⁄ÇæÇØÅvó}Ç¶ÇÈï˚å¸Ç…êUÇÈÅB
    On Error Resume Next
    fr.SpecialEffect = 0       ' fmSpecialEffectFlat (etched ògÇè¡Ç∑)
    Dim bcFrame As Long
    ...
    ' scroll content (frame-relative ç¿ïWÇ≈ frScroll ì‡Ç…ê∂ê¨)
    Dim y As Long
    Dim kOff As Long
    kOff = AddKnowledgeNoRow(fr)                        ' ÉiÉåÉbÉWî‘çÜçs(edit/view); M-05=0
    y = m_margin + kOff
    y = AddHeaderFields(fr, y)                          ' ó\íËî‘çÜ ìô header fields
    ...
    ' å≈íË form inside çÇ: ì‡óeÇ™é˚Ç‹ÇÍÇŒÇªÇÃÇ‹Ç‹ÅAí¥Ç¶ÇΩÇÁ cap Ç≈ frame ì‡ÉXÉNÉçÅ[Éã
    ...
    ' V4 fix (2026-05-29) #M-05: register ÉÇÅ[ÉhÇ≈ frScroll ì‡ÇÃ field åQÇ™
    ' 1 åèÇµÇ© paint Ç≥ÇÍÇ»Ç¢ regression Ç™î≠ê∂ (éq agent dump Ç≈ 11 åèëSç\ízçœ
    ' ämîF)ÅBframe ÇÃ ScrollTop Ç 0 Ç… reset + Repaint nudge Ç≈èâä˙ï`âÊÇã≠êßÅB
    On Error Resume Next
...
' Phase R-3-É‘-4: find a control by name on the live form, searching direct
' controls then the frScroll frame's children (one level). field ånÇÕ frScroll ì‡ÅB
...
Private Sub PopulateComboBoxesOnInstance(ByVal uf As Object)
    ...
    For Each ctlName In m_comboItemsByCtl.Keys
        ...
        Dim cb As Object
        Set cb = FindCtlOnForm(uf, CStr(ctlName))   ' R-3-É‘-4: frScroll frame ì‡Ç‡íTçı
...
Private Function ResolveFormTitle() As String
    ...
    Select Case m_mode
        ...
        Case "preview"
            ' ÉvÉåÉrÉÖÅ[ (V4 fix 2026-05-29: drop ": <formatId>" suffix perêeéwé¶#4)
...
Private Function ComputeRowsHeight(ByVal flds As Collection) As Long
    ...
    For i = 1 To flds.count
        ...
        If sec.GetValue("FieldType") = ChrW(&H8907) & ChrW(&H6570) & ChrW(&H884C) Then  ' ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?s
            ' Long multi-line for known "long" fields (?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??Óy, ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?, ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E? ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?); others use short
...
Private Function IsLongMultilineField(ByVal fieldName As String) As Boolean
    Dim s As String
    s = fieldName
    ' ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??Óy / ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E? / ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E? / ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E???? / ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??? / ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?e ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?c
...
Private Function AddKnowledgeNoRow(ByVal designer As Object) As Long
    If m_knowledgeNoRow <> "editable" And m_knowledgeNoRow <> "readonly" Then
        ...
        Exit Function
    End If
    ' Phase R-3-É‘-3 ècï¿Ç—: label çsè„ÅEdata çs(ëSïù)â∫ÅB
    Dim y As Long
    y = m_margin
...
Private Function AddHeaderRow(ByVal designer As Object) As Long
    ...
    ' Phase R-3-É‘-3 ècï¿Ç—: format selector Ç‡ label è„ÅEdata ëSïùâ∫ÅB
    Dim ctlW As Long
    ...
    ' Phase R-2 F-2 / R-3-É‘-3: help line under the format selector (data çsíºâ∫)ÅB
    Dim helpH As Long
...
Private Function ResolveHeaderFieldLabel(ByVal id As String) As String
    Select Case LCase$(Trim$(id))
        Case "knowledgeid": ResolveHeaderFieldLabel = ChrW(&H4E88) & ChrW(&H5B9A) & ChrW(&H756A) & ChrW(&H53F7)        ' ó\íËî‘çÜ
        Case "createdat":   ResolveHeaderFieldLabel = ChrW(&H767B) & ChrW(&H9332) & ChrW(&H65E5) & ChrW(&H6642)        ' ìoò^ì˙éû
        Case "updatedat":   ResolveHeaderFieldLabel = ChrW(&H66F4) & ChrW(&H65B0) & ChrW(&H65E5) & ChrW(&H6642)        ' çXêVì˙éû
...
Private Function AddHeaderFields(ByVal designer As Object, ByVal yStart As Long) As Long
    ...
    For k = LBound(ids) To UBound(ids)
        ...
        If Len(id) > 0 Then
            ...
            ' Phase R-3-É‘-3 ècï¿Ç—: header field Ç‡ label è„ÅEdata ëSïùâ∫ÅB
            ...
            Dim hfExtra As Long
            hfExtra = 0
            ' Phase R-2 F-2: per-header-field help line (data çsíºâ∫)ÅB
...
' Apply ÉÅÉCÉäÉI base font (Phase R-1-c, spec ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?1)
...
Private Function AddFieldRow(ByVal designer As Object, _
    ...
    ' Phase R-3-É‘-3 ècï¿Ç—: label ÇÕè„ÇÃçsÅEëSïù(badge ï™ÇçTèú)ÅB
    ...
    If isReq Then
        ...
        ' ècï¿Ç—: badge ÇÕ label çsÇÃâEí[Ç…îzíu
    ...
    Select Case fieldType
        ...
        Case ChrW(&H8907) & ChrW(&H6570) & ChrW(&H884C)  ' ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?s
            ...
            End Select
            ctl.Text = curVal
            ' Long multi-line for ?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??Óy/?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?/?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?/?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E???/?E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E??E?E?E?E?E?E?E?E?E?E?E?E?E?E?E?e; others short
    ...
    ' Phase R-3-É‘-3 ècï¿Ç—: data ÇÕ label çsÇÃâ∫ÅEëSïùÅB
    ' dataHeight = çsÉsÉbÉ`(rowH) - labelZone(VLABEL_H+VLABEL_GAP) - VROW_SPACINGÅB
    ...
    ' Apply mode-based locking (view Ç∆ preview ÇÕï\é¶êÍóp = readonly)
    ...
    ' Phase R-3-É‘-2: preview (M-04) ÇÕé¿ÉfÅ[É^ÇéùÇΩÇ∏ placeholder(ãLì¸ó·)ÇÃÇ›ï\é¶ÅB
    ' readonly ÇÃÇΩÇﬂ focus-clear ÉnÉìÉhÉâÇÕê∂ê¨ÇπÇ∏ static Ç…èoÇ∑ÅB
...
Private Sub AddButtonBar(ByVal designer As Object, ByVal y As Long)
    ...
    Select Case m_mode
        ...
        Case "view"
            ...
            kinds = Split("s|d|p", "|")
        Case "preview"
            ' Phase R-3-É‘-2: M-04 ÉvÉåÉrÉÖÅ[ÇÕÅuï¬Ç∂ÇÈÅvíPì∆ (M-09 Ç∆ìØ btnClose)
    ...
    For i = 0 To n - 1
        ...
        End Select
        ' V5 fix (2026-05-30) BUG-2: Default/Cancel ñæé¶ setÅBprimary(p) Ç Enter Ç≈î≠âŒÇ∑ÇÈ
        ' Default Ç…ÅAClear/Close Ç Esc Ç≈î≠âŒÇ∑ÇÈ Cancel Ç…ÅBÇ±ÇÍÇ≈ Tab Ç≈ field à⁄ìÆíÜÇÃ
        ' åÎ Enter Ç™ÅuÉNÉäÉAÅvÇî≠âŒÇµÇƒ field ëSè¡é∏Ç∑ÇÈ UX éñåÃÇñhÇÆÅB
        On Error Resume Next
        Select Case kinds(i)
            Case "p"
                btn.Default = True
            ...
            Case Else
                btn.Default = False
                ' btnClear / btnClose Ç Esc ÉLÅ[Ç≈î≠âŒÇ≥ÇπÇÈ
        ...
        ' R-3-g1A (2026-05-28): per-button help (mock èÄãíÅAàƒc ìùçáï‚èïï∂ÇìPâÒ)ÅB
        ' buttonWidth(113) ïùì‡Ç…é˚ÇﬂâEÇ›Ç´ÇÍ/èdÇ»ÇËÇâÒîÅB
...
Private Sub InjectFormCode(ByVal vbc As Object)
    ...
    ' Phase R-3-É‘-5: format çsÇ™ñ≥Ç¢ mode Ç≈ÇÕ cboFormatId Ç™ë∂ç›ÇµÇ»Ç¢ÇΩÇﬂ inject ÇµÇ»Ç¢ÅB
...
Private Sub DumpFormToFile(ByVal vbc As Object, ByVal designer As Object, _
    ...
    ' R-3-É‘-4: designer.Controls ÇÕ frame éqÇ‡ flatten ÇµÇƒä‹Çﬁ(frame-relative ç¿ïW)ÇΩÇﬂÅA
    ' frame éqÇÕ [CONTROLS] Ç©ÇÁèúäOÇµ [FRAMECONTROLS] Ç…ÇÃÇ›èoÇ∑ÅB
    ...
    ' Phase R-3-É‘-4: frScroll frame geometry + ÇªÇÃéq controls (frame-relative ç¿ïW)
    s = s & "[FRAME]" & vbCrLf
