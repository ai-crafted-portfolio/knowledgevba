...
Private Const ALL_FORMATS_TOKEN As String = "すべて"
...
Private Function BuildResultRow(ByVal rowNo As Long, ByVal knwNo As String) As Object
    ...
    d("Title") = ExtractKeyValueFromItems(content, "タイトル")
    d("Excerpt") = BuildExcerpt(content)
    d("Category") = ExtractKeyValueFromItems(content, "カテゴリ")
    d("Assignee") = ExtractKeyValueFromItems(content, "担当者")
...
Private Function BuildExcerpt(ByVal content As String) As String
    Dim s As String
    s = ExtractKeyValueFromItems(content, "事象")
