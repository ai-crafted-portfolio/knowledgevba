...
以下の bat と ps1 を 2 ファイル、自分の PC の同じフォルダ (例: デスクトップに新規フォルダを作って) に保存してから、bat に空の `.xlsm` をドラッグ＆ドロップすると、シート 14 個・ボタン 29 個・全 VBA モジュールが自動的に展開され、ナレッジ管理ツール本体が構築されます。
...
下のコードを **同じフォルダ** に `Install-KnowledgevbaModules.ps1` というファイル名で保存します。VBA モジュール本体 (49 個) がすべて埋め込まれているため、ファイルサイズは約 340 KB あります。
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsFileFormatScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsFormatDesignScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsFormatListScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsFormatPreviewScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsKnowledgeRegisterScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsKnowledgeViewScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsLogScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsMigrationScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsSearchScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsStorageScreen.Setup] ERROR: " & Err.Description
End Sub
...
Public Sub Setup()
    ...
    Exit Sub
ErrHandler:
    Debug.Print "[clsSystemSettingsScreen.Setup] ERROR: " & Err.Description
End Sub
...
''         旧 PlaceButtonsOnXxxSheet の手続き型ロジックは画面層クラス
''         （clsXxxScreen + clsScreenSpec + clsSheetRenderer）に分割移行済み。
'' 依存先: clsSetupOrchestrator, modFactory
'' 備考:   ユーザは VBE で全モジュールを Import 後、本マクロ
''         SetupSheetsAndButtons を Alt+F8 で 1 回実行する。
...
'' ================================================================
'' 関数名: ResetAllScreens
'' 概要:   全 14 画面を再描画する（再セットアップ用、シート保持）
'' 備考:   シートは作成しない。spec を最新化したいときに使う。
'' ================================================================
Public Sub ResetAllScreens()
    ...
    For i = LBound(screenIds) To UBound(screenIds)
        Dim screen As Object
        Set screen = modFactory.CreateScreen(CStr(screenIds(i)), renderer)
        If Not screen Is Nothing Then screen.Render
    Next i
    MsgBox "全 14 画面を再描画しました。", vbInformation, "Reset"
    Exit Sub
ErrHandler:
    MsgBox "再描画に失敗: " & Err.Description, vbCritical
End Sub
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
'@ }
