...
標準モジュール（.bas）です。下記コードをコピーし、`modSheetMap.bas` というファイル名で保存して、VBE の「ファイル → ファイルのインポート」で取り込みます。詳しい手順は[導入手順](../../setup.md)を参照してください。
...
Public Function SheetToScreenId(ByVal sheetName As String) As String
    Select Case sheetName
        ...
        Case SHEET_FILE_FORMAT:    SheetToScreenId = "M-13"
...
Public Function ScreenIdToSheet(ByVal screenId As String) As String
    Select Case screenId
        ...
        Case "M-13": ScreenIdToSheet = SHEET_FILE_FORMAT
